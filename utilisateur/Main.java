...
public class Main{
    public static void main(String[] args){
        ...
        Transport t2 = new Transport(true,Taille.P,3000,10);
        ...
        System.out.println("empreinte de u : "+u.getEmpreinte());
        ...
        Transport t12 = new Transport(true,Taille.P,3000,5);
        Transport t22 = new Transport(true,Taille.G,4000,10);
        //ServicesPublics s = ServicesPublics.getInstance();
